...
/*
	Class that can intercept key press input so that it can be redirected to the Dynamic key
*/
class FKeyInterceptMessageHandler : public FGenericApplicationMessageHandler, public TSharedFromThis<FKeyInterceptMessageHandler>
{
...
public:
	...
	FKeyInterceptMessageHandler(const TSharedPtr<FGenericApplicationMessageHandler>& InTargetHandler);

	virtual ~FKeyInterceptMessageHandler();
